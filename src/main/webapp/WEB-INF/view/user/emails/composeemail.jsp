...
<div class="the-box transparent full">
	<ol class="breadcrumb primary">
	  <li><a href="#fakelink">Compose Email </a></li>
	</ol>
</div>
...
<div class="col-sm-12">
	...
	<label>To Email <span style="color:red;">*</span> : </label>
		<select data-placeholder="Choose a To EMail..." class="form-control chosen-select" multiple name="emails" required="required">
		  <option value="">Choose a To EMail...</option>
		 <c:forEach items="${allemails}" var="allemail">
		    <option value="${allemail}">${allemail}</option>
		 </c:forEach>
		</select>
	</div>
	<div class="form-group">
	...
	<textarea class="form-control" name="message" id="editor1" maxlength="800"></textarea>
</div>
<div class="form-group">
