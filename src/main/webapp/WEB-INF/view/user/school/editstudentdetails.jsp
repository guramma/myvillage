...
<legend>Student Information</legend>
 <form role="form" action="${contextPath}/user/update-student-process" method="post" id="signupvalidation" novalidate="novalidate" enctype="multipart/form-data">
<div class="row">
	<div class="col-sm-3">
		<div class="form-group has-feedback left-feedback no-label">
		  <input type="text" class="form-control" placeholder="First Name" name="firstName" value="${student.firstName}">
...
<div class="col-sm-3">
	<div class="form-group has-feedback left-feedback no-label">
	  <input type="text" class="form-control" placeholder="Last Name" name="lastName" value="${student.lastName}">
	  <span class="fa fa-user form-control-feedback"></span>
	</div>
</div>
<div class="col-sm-3">
...
<div class="col-sm-3">
	<div class="form-group has-feedback left-feedback no-label">
	  <input type="text" class="form-control" placeholder="Mother Name" name="motherName" value="${student.motherName}">
	  <span class="fa fa-user form-control-feedback"></span>
	</div>
</div>
<div class="col-sm-3">
	<div class="form-group has-feedback left-feedback no-label">
	  <input type="text" class="form-control" placeholder="Father Name" name="fatherName" value="${student.fatherName}">
	  <span class="fa fa-user form-control-feedback"></span>
	</div>
</div>
<div class="col-sm-3">
...
<div class="col-sm-2">
	<div class="form-group has-feedback left-feedback no-label">
	  <input type="password" class="form-control" placeholder="Password" maxlength="10" name="password" id="password" value="${student.password}">
	  <span class="fa fa-lock form-control-feedback"></span>
	</div>
</div>
<div class="col-sm-1">
	<div class="form-group has-feedback left-feedback no-label">
	  <input type="checkbox" id="checkpassword" style="transform: scale(1.6);margin-top: 10px;" onclick="showhidepassword()">
	</div>
</div>
<div class="col-sm-12">
	<div class="form-group has-feedback left-feedback no-label">
	  <textarea rows="" cols="" class="form-control" placeholder="Address" name="address">${student.address}</textarea>
	  <span class="fa fa-user form-control-feedback"></span>
	</div>
</div>
<div class="col-sm-3">
...
<div class="col-sm-3">
	<div class="form-group has-feedback left-feedback no-label">
	  <input type="text" class="form-control" placeholder="Country" name="country" value="${student.country}">
	  <span class="fa fa-flag-checkered form-control-feedback"></span>
	</div>
</div>
<div class="col-sm-3">
	<div class="form-group has-feedback left-feedback no-label">
	  <input type="text" class="form-control" placeholder="Zipcode" name="zipcode" value="${student.zipcode}">
...
<div class="col-sm-3">
	<div class="form-group has-feedback left-feedback no-label">
	 <input type="text" class="form-control" placeholder="School Name" name="schoolName" value="${student.schoolName}">
	  <span class="fa fa-users form-control-feedback"></span>
	</div>
</div>
<div class="col-sm-3">
...
<div class="col-sm-3">
	<div class="form-group has-feedback left-feedback no-label">
	<input type="text" class="form-control" name="dateofBirth" id="datepickers" required="required" placeholder="Date of Birth" value="${student.dateofBirth}"/>
	  <span class="fa fa-users form-control-feedback"></span>
	</div>
</div>
<div class="col-sm-3">
	<div class="form-group has-feedback left-feedback no-label">
	  <input type="text" class="form-control" placeholder="Phone Number" maxlength="10" name="phoneNumber" value="${student.phoneNumber}">
...
<input type="hidden" class="form-control" placeholder="studentId" maxlength="10" name="studentId" value="${student.studentId}">
<input type="hidden" class="form-control" placeholder="studentId" maxlength="10" name="userProfileModifiedName" value="${student.userProfileModifiedName}">
</div>
<button type="submit" class="btn btn-success btn-block btn-lg"><i class="fa fa-sign-in"></i> Update Student Details</button>
</form>
</fieldset>
</div>
