...
<jsp:body>
<title> All Festival Musics</title>
...
<div class="caption text-center">
	<p class="small">
    <a href="${contextPath}/user/view-festival-musics?festivalname=${festivalMusic.festivalName}"><button type="button" class="btn btn-success"><i class="fa fa-sign-in"></i> View</button></a>
	<span><a href="${contextPath}/user/download-festival-musics?festivalname=${festivalMusic.festivalName}"><button type="button" class="btn btn-success"><i class="fa fa-sign-in"></i> Download</button></a></span>
</div>
</div>
</div>
</c:forEach>
