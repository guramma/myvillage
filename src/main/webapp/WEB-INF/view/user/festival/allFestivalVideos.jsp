...
<jsp:body>
<title> All Festival Videos</title>
...
<div class="caption text-center">
	<p class="small">
    <a href="${contextPath}/user/view-festival-videos?festivalname=${festivalVideo.festivalName}"><button type="button" class="btn btn-success"><i class="fa fa-sign-in"></i> View</button></a>
